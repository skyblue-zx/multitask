...
class DiDiDataset(Dataset):
    def __init__(self, data, audio_dir, vocabulary_dict, audio_length=None, predict=False):
        """
        构造函数
        :param data_list:
        :param audio_length:
        ...
        self.label_list, self.asr_label_list, self.audio_list, self.asr_list = DiDiDataset.read_data(data,
                                                                                                     self.audio_dir,
                                                                                                     self.predict)
    ...
    def collate(cls, sample_list):
        ...
        return ((batch_audio, audio_length), (batch_text, text_length)), batch_label, batch_asr_label, batch_name
